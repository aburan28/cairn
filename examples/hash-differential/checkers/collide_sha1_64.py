"""Certificate checker: a conforming pair for SHA-1 reduced to 64 steps.

SHA-1 cut to its first 64 steps: same padding, same expansion, same round
...
Cost is roughly 2^35 compressions with a published 64-step path.
...
# own author chose.
PREFIX_SEED = "cairn hash-differential v1 sha1-64"
PREFIX = bytes.fromhex(
    "c7bc75a5c96e713d3f608092a08f595f421d7e8f3dcc967878f964abcc1c4f09"
    "3ce4be66aa8f4059e1f69abc39e728f6958228ddd0afd6e2fd1ef98507db3149"
)
# Compression steps actually run.
# Reduced from 80: the last 16 steps are not run, so this is a
