"""Certificate checker: a conforming pair for MD5, truncated to 48 bits.

This is the rung that exists to be climbed on the way in, and its answer
...
differing somewhere, whose first 48 digest bits agree. Nothing else.
...
Cost is about 2^24 MD5 computations, by any method at all.
...
# own author chose.
PREFIX_SEED = "cairn hash-differential v1 md5-48"
PREFIX = bytes.fromhex(
    "aa34609ea84c691870a89506a66babb5c4ef2b6c2e11eb4d68e32d798b91ce65"
    "c6b782abc8ae04bb273b7f3fd4d1bac99002455bdcc24ca4065ed9aa018c82e8"
)
# Compression steps actually run.
# All of them -- the unmodified function.
STEPS = 64
# Leading digest bytes that must agree.
# Truncated from 16: only the leading 48 bits have to agree,
...
_CLAIM = "agreement on the leading 48 digest bits"
_ENDIAN = "little"
