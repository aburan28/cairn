...
#
# The v2 seed is deliberate. A v1 instance was derived, solved by Pollard rho to
# prove the pipeline end to end, and is now a *test vector* rather than an
# objective (instances/testvector-50.json) -- because once its answer is known,
# posting it would settle instantly for the first copier and mint nothing.
#
# n is prime, so the group is cyclic and the hashed Q is guaranteed to lie in
# <G>: the instance cannot be quietly unsolvable.
# Pollard rho cost: about 2^25 group operations.
