...
The answer objective for this instance -- objective-nums-50.json -- pays once, for
...
def check(artifact: dict) -> tuple[bool, str]:
    ...
    return True, f"verified: a distinguished point of the nums-50 walk (about 2^{DP_BITS} steps of work)"


# -- the pinned instance and walk ----------------------------------------------
#
# The curve, P, Q and n are exactly those of checkers/nums_50.py -- the
