...
certicom ecc2k-130 -- where a point cannot carry its own coefficients.
`objective-ecc2k130.json` pays once, for `k`; this one pays for the search that
...
def check(artifact: dict) -> tuple[bool, str]:
    ...
    for index, element in enumerate(dps):
        ...
        seen.add(element["x"])
    return True, f"verified: {len(dps)} distinguished orbits of the certicom ecc2k-130 walk (about 2^25 steps each)"
...
M = 131
POLY = 2722258935367507707706996859454145699847
CURVE_A = 0
CURVE_B = 1
ORDER_N = 680564733841876926932320129493409985129
GEN_X = 1739428527072892489743773309172989924522
GEN_Y = 1423119348103981021643892013163199690941
TARGET_X = 2309658012506412099988466246134815930289
TARGET_Y = 1578526100003023531340803776621036465818
FROBENIUS_S = 196511074115861092422032515080945363956
NB_GENERATOR = 177131680112037587570718881624972258959
J_BASE = 3
J_COUNT = 8
START_TERMS = 128
DP_MAX_WEIGHT = 34
DP_BITS = 25
MAX_BATCH = 64
MAX_STEPS = 1073741824
JOB = "examples/certicom-ecdlp/jobs/ecc2k130.json"
JOB_SHA256 = "493f92c981c13756e45864f02e22364344944362a8b900587cb36ac9dc4b126f"
JOB_ID = "1b41754d63526f77280f57d805cebe3191b5ed2cbdef02d2ce1a9e02cb40115d"
