...
The answer to certicom ecc2k-130. Finding `k` with `[k]P = Q` takes about
...
The companion objective `objective-ecc2k130-orbit-batch.json` pays for the search itself, orbit
